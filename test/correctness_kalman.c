...
void run_kalman(char *filename) {
    ...
    //print_covariance(trks.covariance[TRKi]);
    //free(measurements);
    //return;
    ...
    while(1) {
        ...
        // printf("pr: %f %f %f %f %f %f %f\n",
        //         trks.x[TRKi], trks.y[TRKi], trks.s[TRKi], trks.r[TRKi],
        //         trks.dx[TRKi], trks.dy[TRKi], trks.ds[TRKi]);
        ...
        // printf("%f %f %f %f\n", trks.x[TRKi], trks.y[TRKi], s, r);
        // printf("up: %f %f %f %f %f %f %f\n\n", 
        //        trks.x[TRKi], trks.y[TRKi], trks.s[TRKi], trks.r[TRKi],
        //        trks.dx[TRKi], trks.dy[TRKi], trks.ds[TRKi]);
    }
